  ...
  return (
    <div className="post">
      ...
      <div className="post-content">
        <p className="post-content-text">{props.description}</p>
      </div>
      ...
      <div id="like-comment-timestamp-parent">
        <div className="like-comment-button-section">
          ...
          <div
            className="comment-button-container" /*style={{ height: "10px" }}*/
          >
            <BiCommentDetail
      ...
      {/* <Comments/> */}
      {mapUsers(comments, props.allUsers).map((ele) => (
        <div id={open ? "noComment" : "allComment"}>
          <Comments key={ele.comment_id} comments={ele.commentary} userInfo={ele.userInfo} />
        </div>
      ))}
      <script
        src="https://kit.fontawesome.com/c53ca3821a.js"
